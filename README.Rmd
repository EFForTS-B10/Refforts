...
The Refforts-Biodiv package is intended to provide scripts for analyzing the biodiversity modul of EFForTS-ABM.
...
Refforts bring some functions to generate price data for rubber and oilpalm.
It uses Geometric Brownian Motion to generate correlated price curves.
Historical monthly price data is used to calculate some characteristics. These characteristics are then used to simulate artificial price curves that are correlated with one another.
