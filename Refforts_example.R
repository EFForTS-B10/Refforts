...
#
#   # only relevant for version "biodiv_birds" #versionspecific
#   "p.bird.richness.max", "p.bird.richness.min", "p.bird.richness.mean"
# )
...
nl@experiment <- experiment(
  ...
  # ("run_biodiversity is only relevant for version "biodiv_birds" # versionspecific)
  runtime = 3, # use a short runtime for testing, takes much longer than main version
  metrics = metrics,
  constants = constants
)
